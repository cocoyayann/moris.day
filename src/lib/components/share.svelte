...
<div id="share">
    ...
    <div class='threads'>
        <a href="https://www.threads.net/intent/post?text={share.title}+-+moris+Blog%0A{share.url}" target="_blank">
            <div>
    ...
    <div class='twitter'>
        <a href="http://twitter.com/share?url={share.url}&text={share.title}+-+moris+Blog%0A" target="_blank">
            <div>
